...
export default function HostingSingapuraSection() {
    return (
        <section className="container mx-auto px-6 mb-12">
            <div>
                <h2 className="font-black text-2xl tracking-wide text-center lg:text-3xl">Paket Hosting Singapura yang Tepat</h2>
                <p className="text-center">Diskon 40% + Domain dan SSL Gratis untuk Anda</p>
            </div>
            <div className="md:flex md:flex-col md:items-center lg:items-start lg:flex-row lg:mt-12">
                <div className="w-full md:flex md:justify-around lg:justify-start">
                    <div className="mt-8 md:w-2/5 lg:mt-0 lg:w-full">
