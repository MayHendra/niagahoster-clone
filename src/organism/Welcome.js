    ...
    return (
        <main className="container mx-auto mt-8 px-6 mb-12 md:mt-10 lg:mt-15">
            <div className="flex flex-col lg:flex-row-reverse lg:justify-between">
                ...
                <div className="mt-8 px-4 md:px-16 lg:px-4">
                    ...
                    <ul className="flex flex-col">
                        {
                            excellences.map((ex, i) => (
                                <li className="flex py-2" key={i}>
                                    <div className="mx-1">
                                        <svg className="w-5 mr-1 mt-px text-green-500 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
