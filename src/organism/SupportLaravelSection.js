    ...
    return (
        <section className="container mx-auto mt-8 px-6 mb-10 md:px-16 lg:mb-16">
            ...
            <div className="md:flex md:flex-col md:items-center lg:flex-row-reverse lg:justify-center">
                ...
                <div>
                    <p className="text-lg py-2 text-justify md:pt-6 md:pb-3">Tak perlu menggunakan dedicated server ataupun VPS yang mahal. Layanan PHP hosting murah kami mendukung penuh framework favorit Anda.</p>
                    <ul className="flex flex-col">
                        <li className="flex py-2">
                            <div className="mx-1">
                                <svg className="w-5 mt-px mt-1 text-green-500 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
